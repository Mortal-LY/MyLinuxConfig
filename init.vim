...
" Set neovim's indicator light in insert mode to metering
...
Plug 'preservim/tagbar' " A plug-in designed for Vim, a visual sidebar that displays the tags and structure of the current file
...
" The current vim looks good font color
color snazzy
" Set the transparency after using snazzy
let g:SnazzyTransparent = 1


" The coc.nvim settting
set hidden
...
inoremap <expr> <Tab> pumvisible() ? "\<C-y>" : CheckBackSpace() ? "\<Tab>" : coc#refresh()
